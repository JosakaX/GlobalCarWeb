document.addEventListener('DOMContentLoaded', () => {
    ...
    window.deleteVehicle = async (id) => {
        if (!confirm('⚠️ ¿Estás seguro de que deseas ELIMINAR permanentemente este vehículo? Esta acción no se puede deshacer.')) {
            return;
        }
        ...
        try {
            ...
            // Minimal toast/alert
            alert('Vehículo eliminado exitosamente del catálogo.');
